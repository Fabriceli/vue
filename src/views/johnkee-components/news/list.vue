            ...
            <Col :md="24" :lg="17" :style="{marginBottom: '10px'}">
                ...
                <Card class="margin-top-10" style="padding-bottom:10px">
                    ...
                    <div  style="padding-left:10px">
                        <p>
                            事件主体：
                            <Tag checkable checked="false" >经济</Tag>
                            <Tag checkable checked color="blue">项目</Tag>
                            <Tag checkable checked="null" color="blue">期货</Tag>
                            <Tag checkable unchecked color="blue">标签四</Tag>
                        </p>
                        <p style="margin-top:7px">
                            发生时间：
                            <Tag checkable checked="false" >过去</Tag>
                            <Tag checkable checked color="blue">最近七天</Tag>
                            <Tag checkable checked="null" color="blue">未来三个月</Tag>
                        </p>
                        <p style="margin-top:7px">
                            信息来源：
                            <Tag checkable checked="false" >官方机构</Tag>
                            <Tag checkable checked color="blue">第三方</Tag>
                            <Tag checkable checked="null" color="blue">社区舆论</Tag>

                        </p>
                        <p style="margin-top:7px">
                            事件类型：
                            <Tag checkable checked="false" >上交易所</Tag>
                            <Tag checkable checked color="blue">融资信息</Tag>
                            <Tag checkable checked="null" color="blue">数据指标</Tag>

                        </p>
                        <p style="margin-top:7px">
                            所属行业：
                            <Tag checkable checked="false" >农业</Tag>
                            <Tag checkable checked color="blue">金融</Tag>
                            <Tag checkable checked="null" color="blue">民生</Tag>

                        </p>
                        <p style="margin-top:7px">
                            事件人物：
                            <Tag checkable checked="false" >人物</Tag>
                            <Tag checkable checked color="blue">团队</Tag>
                            <Tag checkable checked="null" color="blue">机构</Tag>
                            <Tag checkable checked color="blue">国家</Tag>
                        </p>
                        <p style="margin-top:7px">
                            重要程度：
                            <Tag checkable checked="false" >1星</Tag>
                            <Tag checkable checked color="blue">2星</Tag>
                            <Tag checkable checked="null" color="blue">3星</Tag>
                            <Tag checkable checked color="blue">4星</Tag>
                        </p>
                        <p style="margin-top:7px">
                            智能查询：
                                <AutoComplete
